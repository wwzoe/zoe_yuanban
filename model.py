...
class GRU4Rec:
    ...
    def build_model(self):
        ...
        # https: // github.com / DecodersTeam / Tensorflow - Overview / blob / master / tensorflow / python / ops / rnn_cell.py  # L95
        if self.is_training:
            '''
        ...
        self.writer=tf.summary.FileWriter('/home/zoe/PycharmProjects/RecSys-master/checkpoint', tf.get_default_graph())
        ...
        for epoch in range(self.n_epochs):
            ...
            while not finished:
                ...
                for i in range(minlen-1):
                    ...
                    fetches = [self.cost, self.final_state, self.global_step, self.lr, self.train_op,self.summary_op]
